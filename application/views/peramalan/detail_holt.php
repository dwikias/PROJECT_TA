    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h5 class="page-title">Detail Hasil Peramalan Metode DES dari Holt</h5>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-6 px-2">
                <div class="card card-primary">
                    <div class="card-header">
                        <h6 class="card-title">Data Hasil Peramalan</h6>
                    </div>
                    <div class="card-body">
                        <a type="button" class="btn btn-danger btn-sm text-white" target="_blank" href=" <?= base_url(); ?>ramal_holt/cetak">Cetak-Pdf</a>
